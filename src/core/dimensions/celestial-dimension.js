...
export const CelestialDimensions = {
  ...
  get alphaDecaySpeed() {
    return new Decimal(1 - DivineDimensions.conversionFormula3).times(DivinityMilestone.divineDimensions.isReached ? 0.8 : 1).timesEffectOf(DivineUpgrade.divineL1U2).toNumber();
  },
