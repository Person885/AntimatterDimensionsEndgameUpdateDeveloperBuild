...
export const pelleStrikes = {
  infinity: {
    ...
    isDestroyed: () => PelleStrikeUpgrade.pelleStrike1.isBought && !player.disablePostReality
  },
  powerGalaxies: {
    id: 2,
    ...
    isDestroyed: () => PelleStrikeUpgrade.pelleStrike2.isBought && !player.disablePostReality
  },
  eternity: {
    id: 3,
    ...
    isDestroyed: () => PelleStrikeUpgrade.pelleStrike3.isBought && !player.disablePostReality
  },
  ECs: {
    id: 4,
    ...
    isDestroyed: () => PelleStrikeUpgrade.pelleStrike4.isBought && !player.disablePostReality
  },
  dilation: {
    id: 5,
    ...
    isDestroyed: () => PelleStrikeUpgrade.pelleStrike5.isBought && !player.disablePostReality
  }
};
