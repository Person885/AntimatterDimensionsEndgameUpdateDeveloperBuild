export const celestialInfinityUpgrades = {
  ...
  rawCelestialDimMult: {
    id: 3,
    cost: 20,
    description: () => `Multiply all Celestial Dimension Multipliers by ${formatInt(10)} after the softcap`,
    effect: 10
  },
  celDimBoostBuff: {
    id: 4,
  ...
  antimatterCelestialDimBuff: {
    id: 7,
    cost: 1000,
    description: "Multiply all Celestial Dimensions by the Antimatter Exponent's Exponent after the softcap",
